...
model: haiku
context: fork
allowed-tools: Bash(git diff:*), Bash(git diff --stat:*), Bash(git diff --numstat:*), Bash(git diff --name-only:*), Bash(git status:*), Bash(git log:*), mcp__tilth__tilth_search, mcp__tilth__tilth_read
description: >
